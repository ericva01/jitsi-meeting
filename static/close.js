 ...
 */
function onLoad() {
    const displayName = window.sessionStorage.getItem('leavingDisplayName') || 'You';
    // Intentionally use string concatenation because this file does not go through Babel.
    // eslint-disable-next-line prefer-template
    const thankYouMessage = displayName + ' left the meeting';
